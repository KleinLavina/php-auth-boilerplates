...
<div align="center" style="margin-top:50px;">
    <div style="width:400px; border: solid 1px #b7bfa9; border-radius: 10px; box-shadow: 0 4px 10px rgba(0, 0, 0, 0.2);" align="left">
        ...
        <div style="margin:20px; padding:10px; background-color: #7e9f81; color: #e8ebe4;">
            <form action="authentication/check_signup.php" method="post">
				 <label style="font-weight: bold; color: #e8ebe4;">First Name:</label><br />
                <input type="text" name="firstname" class="box" 
				 ...
				 <label style="font-weight: bold; color: #e8ebe4;">Last Name:</label><br />
